...
// main function
void bbcal_atime_offset_kte (char const * configfilename, bool isdebug = 1) {
  ...
  TH2F *h2_ShHcalCoin_vs_rnum = new TH2F("h2_ShHcalCoin_vs_rnum","Before offset correction (SH);Run no.;HCAL ADCtime - SH ADCtime (ns)",Nruns,0.5,Nruns+0.5,h_atime_off_bin,coin_ppos-50.,coin_ppos+50.);
  TH2F *h2_ShHcalCoin_vs_rnum_corr = new TH2F("h2_ShHcalCoin_vs_rnum_corr","After offset correction (SH);Run no.;HCAL ADCtime - SH ADCtime (ns)",Nruns,0.5,Nruns+0.5,h_atime_off_corr_bin,coin_ppos_corr-50.,coin_ppos_corr+50.);
  TH2F *h2_PsHcalCoin_vs_rnum = new TH2F("h2_PsHcalCoin_vs_rnum","Before offset correction (PS);Run no.;HCAL ADCtime - PS ADCtime (ns)",Nruns,0.5,Nruns+0.5,h_atime_off_bin,coin_ppos-50.,coin_ppos+50.);
  TH2F *h2_PsHcalCoin_vs_rnum_corr = new TH2F("h2_PsHcalCoin_vs_rnum_corr","After offset correction (PS);Run no.;HCAL ADCtime - PS ADCtime (ns)",Nruns,0.5,Nruns+0.5,h_atime_off_corr_bin,coin_ppos_corr-50.,coin_ppos_corr+50.);
  ...
  TH2F *h2_hcal_time_vs_rnum = new TH2F("h2_hcal_time_vs_rnum","Before offset correction;Run no.;HCAL ADCtime (ns)",Nruns,0.5,Nruns+0.5,250,-100,150);
